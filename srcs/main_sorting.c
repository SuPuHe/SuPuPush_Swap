...
/*   Updated: 2025/05/01 11:56:03 by omizin           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
 ...
 * @return The distance from the top of the stack to the first element
 * within the range.
 */
...
/**
 * @brief This function moves the top element of stack a to stack b if it
 * is within the chunk range. It also rotates stack a if the top element
 * is not within the chunk range.
 * @param a The pointer to stack a.
 * @param b The pointer to stack b.
 * @param cinfo The chunk information structure containing top distance and size.
 * @param sinfo The sorting information structure containing median and
 * total elements.
 */
 ...
 * compared to the chunk range.  It continues until all elements are sorted
 * or pushed back to stack a.
 * @param a The pointer to stack a.
 * @param b The pointer to stack b.
 * @param info The sorting information structure containing sorted array
 * and total elements.
 ...
 * It checks if stack a is empty or already sorted, and if not,
 * it sorts the elements by pushing them to stack b
 * and then back to stack a.
 * @param a The pointer to stack a.
 * @param b The pointer to stack b.
 */
